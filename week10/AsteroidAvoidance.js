...
ShipSprite.src="images/ShipSprite.jpg";



//background
var spacebackground= new Image();
spacebackground.src = "images/spacebackground.jpg";
...
function PlayerShip(){
    ...
    this.drawShip=function(){
        ...
        ctx.closePath();
        ctx.fill();
        ctx.drawImage(ShipSprite, 0-this.width/2, 0-this.height/2, this.width, this.height);
        ctx.restore();
    }
